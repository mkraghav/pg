...
<div class="inside-banner">
  <div class="container"> 
    <span class="pull-right"><a href="#">Home</a> / Description</span>
    <h2>Description</h2>
</div>
</div>
<!-- banner -->
...
<div class="row">
                ...
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="property-detail.php">pg in Delhi</a></h5>
                  <p class="price">Rs7000-Rs12000</p> </div>
              </div>
<div class="row">
                <div class="col-lg-4 col-sm-5"><img src="images/properties/1.jpg" class="img-responsive img-circle" alt="properties"/></div>
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="property-detail.php">Apartment in Delhi</a></h5>
                  <p class="price">Rs10000-Rs20000</p> </div>
              </div>

<div class="row">
                <div class="col-lg-4 col-sm-5"><img src="images/properties/3.jpg" class="img-responsive img-circle" alt="properties"/></div>
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="property-detail.php">pg in Gurgaon</a></h5>
                  <p class="price">Rs7000-Rs12000</p> </div>
              </div>
...
<div class="row">
                ...
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="property-detail.php">Apartment in Noida</a></h5>
                  <p class="price">Rs10000-Rs20000</p> </div>
              </div>
...
<h2>Paying Guest and Apartments</h2>
<div class="row">
  <div class="col-lg-8">
...
<!-- #Slider Ends -->
  ...
  <p> Situated at 1st floor, this Paying Guest is East facing. Ample space of covered car parking for visitors. Prime facilities are easily accessible from this place with Government Girls Senior Secondary School (0 km ). Other key neighbourhood are DDA Market (0 km ).
<br>
Rental Value: Rs 8,000 (Rs 500 Monthly Maintenance See Other Charges)
<br>
Security Deposit:Rs 8,000
<br>
Landmark: metro station
<br>
StatusImmediately: Available 
<br>
Facing: East
<br>
Timing restriction: No
<br>
Notice Period: 15 Days</p>
...
<div style="width: 100%"><iframe width="100%" height="600" src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=New%20delhi+(Find)&ie=UTF8&t=&z=15&iwloc=B&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"><a href="https://www.mapsdirections.info/en/journey-planner.htm">www.mapsdirections.info</a></iframe></div><br />
...
<p class="price">Rs7000-Rs12000</p>
  <p class="area"><span class="glyphicon glyphicon-map-marker"></span>New Delhi</p>
  
  <div class="profile">
  <span class="glyphicon glyphicon-user"></span> Owner Details
  <p>Mithilesh raghav<br>(+91)898981xxxx</p>
  </div>
</div>
